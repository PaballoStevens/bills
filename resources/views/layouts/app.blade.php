                            ...
                            <div class="collapse" id="collapseApps" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavAppsMenu">
                                    ...
                                    <div class="collapse" id="appsCollapseKnowledgeBase" data-bs-parent="#accordionSidenavAppsMenu">
                                        <nav class="sidenav-menu-nested nav">
                                            <a class="nav-link" href="/admin/records/management-bills-list">Bills List</a>
                                            <a class="nav-link" href="/admin/records/create">Add Bill</a>
                                            <a class="nav-link" href="knowledge-base-category.html">Edit Bill</a>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="appsCollapseUserManagement" data-bs-parent="#accordionSidenavAppsMenu">
                                        <nav class="sidenav-menu-nested nav">
                                            <a class="nav-link" href="/admin/users/user-management-list">Users List</a>
                                            <a class="nav-link" href="/admin/users/user-management-edit-user">Edit User</a>
                                            <a class="nav-link" href="/admin/users/user-management-add-user">Add User</a>
                                            <a class="nav-link" href="/admin/groups/user-management-groups-list">Groups List</a>
                                    ...
                                    <div class="collapse" id="appsCollapsePostsManagement" data-bs-parent="#accordionSidenavAppsMenu">
                                        <nav class="sidenav-menu-nested nav">
                                            <a class="nav-link" href="/admin/alerts/management-alerts-list">Posts List</a>
                                            <a class="nav-link" href="/admin/alerts/create">Create Post</a>
