        ...
        <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-light bg-white" id="sidenavAccordion">
            ...
            <ul class="navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications ">
                    ...
                    <a class="btn btn-icon btn-transparent-dark dropdown-toggle {{$item->Event == '1' ? 'nav-link-notify pulse' :  ''}}" id="navbarDropdownAlerts" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="bell"></i></a>  
                    ...
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownAlerts">
                        ...
                        @if ($item->Event == '1')
                        <a class="dropdown-item dropdown-notifications-item" href="{{$item->id}}">
                            <div class="dropdown-notifications-item-icon bg-warning"><i class="fas fa-lightbulb"></i></div>
                            <div class="dropdown-notifications-item-content">
                                <div class="dropdown-notifications-item-content-details">{{ \Carbon\Carbon::parse($item->created_at)->format( 'M  d,  Y')}}</div>
                        ...
                        <a class="dropdown-item dropdown-notifications-item " href="#!">
                            <div class="dropdown-notifications-item-icon bg-info"><i class="fas fa-faucet"></i></i></div>
                            <div class="dropdown-notifications-item-content">
                                <div class="dropdown-notifications-item-content-details">{{ \Carbon\Carbon::parse($item->created_at)->format( 'M  d,  Y')}}</div>
                        ...
                        @if ($item->Event == '3')
                        <a class="dropdown-item dropdown-notifications-item " href="#!">
                            <div class="dropdown-notifications-item-icon bg-info"><i class="fas fa-exclamation-triangle"></i></div>
                            <div class="dropdown-notifications-item-content">
                                <div class="dropdown-notifications-item-content-details">{{ \Carbon\Carbon::parse($item->created_at)->format( 'M  d,  Y')}}</div>
                                <div class="dropdown-notifications-item-content-text">{{$item->dec}}</div>
                            </div>
                        </a>
                        @else
                ...
                <li class="nav-item dropdown no-caret dropdown-user me-3 me-lg-4">
                    <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid" src="/uploads/avatars/{{Auth::user()->avatar}}" /></a>
                    <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            <img class="dropdown-user-img" src="/uploads/avatars/{{Auth::user()->avatar}}" />
