...
<main>
    ...
    <div class="container-xl px-4 mt-4">
        ...
        <nav class="nav nav-borders">
            ...
            <a class="nav-link active" href="/account/notifications">Notifications</a>
        </nav>
        <hr class="mt-0 mb-4">
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="inputNotificationEmail" type="email" value="{{Auth::user()->email}}" disabled="">
                            </div>
